...
var wasmBinaryFile = 'blessed_text_window.wasm';
...
var ASM_CONSTS = {
  2632: function($0, $1) {term.cursorSet($0, $1);},  
 2660: function($0, $1, $2, $3) {term.setChar($0, $1, $2, $3);},  
 2694: function() {return term.crsrBlinkMode ? 0 : term.crsrBlockMode ? 1 : 2;},  
 2760: function() {return term.conf.rows;},  
 2789: function() {return term.conf.cols;},  
 2818: function() {term = new Terminal({ termDiv: 'termDiv', handler: function() {}, x: 0, y: 0, initHandler: function() { term.charMode = true; term.keylock = true; term.cursorOn(); afterInit(); } }); term.open();},  
 3033: function($0, $1) {term.resizeTo($0, $1);},  
 3060: function() {term.cursorOn()},  
 3076: function() {term.cursorOff()}
};
...
var asmGlobalArg = {};
var asmLibraryArg = { "__cxa_allocate_exception": ___cxa_allocate_exception, "__cxa_atexit": ___cxa_atexit, "__cxa_throw": ___cxa_throw, "__handle_stack_overflow": ___handle_stack_overflow, "abort": _abort, "abs": _abs, "clock_gettime": _clock_gettime, "emscripten_asm_const_iii": _emscripten_asm_const_iii, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_set_main_loop": _emscripten_set_main_loop, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_seek": _fd_seek, "fd_write": _fd_write, "memory": wasmMemory, "setTempRet0": _setTempRet0, "table": wasmTable, "time": _time };
var asm = createWasm();
Module["asm"] = asm;
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _keydown_handler = Module["_keydown_handler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["keydown_handler"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _keyup_handler = Module["_keyup_handler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["keyup_handler"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _mouse_down_handler = Module["_mouse_down_handler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["mouse_down_handler"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _mouse_up_handler = Module["_mouse_up_handler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["mouse_up_handler"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _mouse_move_handler = Module["_mouse_move_handler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["mouse_move_handler"].apply(null, arguments)
};
